...
[Singleton]
internal class NavigationService(INavigationViewPageProvider pageProvider) : INavigationService
{
    /// <summary>
    ...
    /// <inheritdoc />
    public INavigationView GetNavigationControl() => NavigationControl ?? throw new ArgumentNullException(nameof(NavigationControl));
